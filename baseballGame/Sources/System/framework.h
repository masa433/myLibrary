...
public:
	...
	int run()
	{
		...
		IMGUI_CHECKVERSION();
		ImGui::CreateContext();
		ImGui::GetIO().Fonts->AddFontFromFileTTF(".\\resources\\Font\\ArialUni.ttf", 18.0f, nullptr, glyphRangesJapanese);
...
#if 1
		IDXGISwapChain* swap_chain = Graphics::Instance().GetSwapChain();
		if (swap_chain)
		{
			BOOL fullscreen = 0;
